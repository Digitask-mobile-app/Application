...
class Item(models.Model):
    ...
    port_number = models.SmallIntegerField(default=0, blank=True, null=True)
...
class WarehouseHistory(models.Model):
    ...
    delivery_note = models.TextField(
        null=True, blank=True, default="Qeyd yoxdur")

    task = models.ForeignKey(
        'services.Task', on_delete=models.CASCADE, null=True, blank=True)
