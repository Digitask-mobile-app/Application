...
urlpatterns = [
    ...
    path('create_warehouse/', views.CreateWarehouseView.as_view(),
    ...
    path('increment_import/', views.IncrementItemView.as_view(),
         name='increment-item'),
    path('increment_history/', views.HistoryIncrementListView.as_view(),
         name='increment-history'),
    path('import/', views.ItemImportView.as_view(), name='warehouse-item-import'),
    path('export/', views.DecrementItemView.as_view(),
         name='warehouse-item-export'),
