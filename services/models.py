...
class History(models.Model):
    ...
    item_model = models.CharField(max_length=255,null=True,blank=True)
    item_mac = models.CharField(max_length=255,null=True,blank=True)
    item_port_number = models.PositiveIntegerField(null=True,blank=True)
    item_serial_number = models.CharField(max_length=255,null=True,blank=True)
    item_size_length = models.DecimalField(max_digits=10, decimal_places=2,null=True,blank=True)
