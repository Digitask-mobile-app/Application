...
class Internet(models.Model):
    ...
    internet_packs = models.ForeignKey(
        Internet_packages, on_delete=models.CASCADE, null=True, blank=True)
...
class WarehouseChange(models.Model):
    ...
    task = models.ForeignKey(
        Task, on_delete=models.CASCADE, related_name='task_items')
    item = models.ForeignKey(
        Item, on_delete=models.CASCADE, related_name='item_tasks')
    count = models.PositiveIntegerField()
    delivery_note = models.TextField(
        blank=True, null=True, default="qeyd yoxdur")
    is_tv = models.BooleanField(default=False)
    is_internet = models.BooleanField(default=False)
    is_voice = models.BooleanField(default=False)
